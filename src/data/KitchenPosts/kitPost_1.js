...
function KitPost_1() {
 ...
 <div className="blogHeaderKit">
      ...
      <p>I was always scrawny growing up.  My family didn't eat unhealthy, per se... we ate frugally.  There were 6 kids in my family so dinners were often filled with the cheapest hamburger meat available.  We drank milk, ate bread, our cheese was always orange & came in giant bag from Costco, and pancakes were a staple.</p>
      ...
      <p>The weight crept on so slowly that I didn't really even notice it.  When I was 32 I had one of those eye opening moments when I saw myself for what seemed like the first time.  I was in Switzerland and I had set off on a hike.  At some point, I set up the self-timer on my camera to snap a picture of myself along this lovely trail. When I downloaded the pictures, I saw my bulkyness is full view!  I think I hadn't really noticed it before, but there it was.  After that trip I decided it was time to make some changes.</p>
      <div className="postImageContainer">
          <img className="kitchenImage" src='../../../BlogPostImages/SwissHike.jpg' alt="cooking in the kitchen"/>
      </div>
      ...
      <p>I calculated my BMI: 30.1 Then I looked at the BMI Categories..."Obesity = BMI of 30 or greater" I was considered to by obese. Oof!</p>
      <p></p>
      </div>
