...
function KitPost_1() {
 ...
 <div className="blogHeaderKit">
      ...
      <div className="postImageContainerRight">
      ...
      <p>The weight crept on so slowly that I didn't really even notice it.  When I was about 35 I had one of those eye opening moments when I saw myself for what seemed like the first time.  I was in Switzerland and I had set off on a hike.  At some point, I set up the self-timer on my camera to snap a picture of myself along this lovely trail. When I downloaded the pictures, I saw my bulkyness is full view!  I think I hadn't really noticed it before, but there it was.  After that trip I decided it was time to make some changes.</p>
